...
class Welcome extends Component {
  ...
  fetchWeather = () => {
    return fetch(`http://api.aerisapi.com//observations/10010?client_id=${accessId}&client_secret=${APIkey}`)
    .then((res) => res.json())
  }
  ...
  render() {
    ...
    return (
      <div className="Welcome section">
        ...
        <br/>
          <a href="https://drive.google.com/file/d/1hCBsKbK_89p_gnv508ri8GScHPbTdwOO/view?usp=sharing" target="_blank" rel="noopener noreferrer"><button className="button resume-button">Resume <i className="fa fa-file-pdf-o" aria-hidden="true"/></button></a>
