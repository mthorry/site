  ...
  render() {
    return (
      <div className="About section">
        ...
        <p className="about-item">Matt is <strong>passionate</strong> about technology, science, our planet, travel and making people laugh. He is currently <strong>a web development assistant instructor at <a href="www.c4q.nyc/about" target="_blank" rel="noopener noreferrer" rel="noopener noreferrer">C4Q <i className="fa fa-external-link"/></a> </strong>but is open to opportunities as a software engineer. <a href="mailto:mthorry@gmail.com?Subject=Hello%20there!" target="_top" ><span>Let him know if you're interested!</span> <i className="fa fa-paper-plane" aria-hidden="true"/></a></p>
      </div>
    );
  }
}
